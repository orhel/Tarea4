...
public class Evaluar {
	...
	public void getMenor() {
		...
		assertEquals("Error", 20, Ejercicios.getMenor(al));
		assertEquals("Error", 3, Ejercicios.getMenor(al2));
	}
	...
	public void existe() {
		...
		assertEquals("Error ejecutando exite(al,10)", 2, Ejercicios.contar(al,"10"));
		assertEquals("Error ejecutando exite(al,30)", 0, Ejercicios.contar(al,"30"));
		assertEquals("Error ejecutando exite(al,70)", 1, Ejercicios.contar(al,"50"));
		
		assertEquals("Error ejecutando exite(al,1)", 3, Ejercicios.contar(al2,"1"));
		assertEquals("Error ejecutando exite(al,3)", 1, Ejercicios.contar(al2,"3"));
		assertEquals("Error ejecutando exite(al,7)", 0, Ejercicios.contar(al2,"7"));
	}
